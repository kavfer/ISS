   ...
   <form action="" method="post">
      ...
      <form action="" method="post">
         ...
         <div class="user-info">
            ...
            <a href="update_address.php" class="btn">Enter your delievery address</a>
            <br><br>
            <h2><b> * Cash On Delievery Only</h2>
            <br>
         ...
         <br><br>
         <h2><b> * Please click the button "confirm order" after place the order.</h2>
         ...
         <input type="hidden" name="email" value="<?= $fetch_profile['email'] ?>">
         <input type="hidden" name="address" value="<?= $fetch_profile['address'] ?>">
         <input type="submit" value="confirm order" class="btn" style="width:100%; background:var(--red); color:var(--black);" name="submit">
         </form>
